...
Sword::Sword(unsigned damageMin, unsigned damageMax, unsigned range, unsigned value, std::string texture_file) : MeleeWeapon(damageMin, damageMax, range, value, texture_file) {
